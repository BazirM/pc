...
void draw() {
  ...
  switch(state){
    case start_window:
      ...
      break;
    case login_window:
    System.out.println("stGameOver = " + st.game_over);
      showLogin();
      if(st.game_over){
            System.out.println("stGameOver2= " + st.game_over);
    ...
    case game_window:
      showGame();
      System.out.println("stGameOver3= " + st.game_over);
      if(st.game_over){
        System.out.println("stGameOver4= " + st.game_over);
        state = login_window;
      }
      break;
  }
